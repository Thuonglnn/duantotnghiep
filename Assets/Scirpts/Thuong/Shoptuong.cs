...
public class Shoptuong : MonoBehaviour
{
    ...
    IEnumerator GetCoin(string username)
    {
        ...
        var request = new UnityWebRequest("http://localhost:3005/users/get-score?username=" + username, "GET");
    ...
    {
        // Tạo yêu cầu GET đến API lấy điểm số
        var request = new UnityWebRequest("http://localhost:3005/users/get-diamond?username=" + username, "GET");
        request.downloadHandler = new DownloadHandlerBuffer();
    ...
    IEnumerator Shoptuong1(ShoptuongModel shoptuongModel)
    {
        ...
        var request = new UnityWebRequest("http://localhost:3005/users/buy-general", "POST");
    ...
    IEnumerator postscore(ScoreModel scoreModel)
    {
        ...
        var request = new UnityWebRequest("http://localhost:3005/users/update-score", "POST");
        byte[] bodyRaw = Encoding.UTF8.GetBytes(jsonStringRequest);
        request.uploadHandler = new UploadHandlerRaw(bodyRaw);
        request.downloadHandler = new DownloadHandlerBuffer();
        request.SetRequestHeader("Content-Type", "application/json");
    ...
    IEnumerator postdiamond(DiamondModel diamondModel)
    {
        ...
        var request = new UnityWebRequest("http://localhost:3005/users/update-diamond", "POST");
        byte[] bodyRaw = Encoding.UTF8.GetBytes(jsonStringRequest);
        request.uploadHandler = new UploadHandlerRaw(bodyRaw);
        request.downloadHandler = new DownloadHandlerBuffer();
        request.SetRequestHeader("Content-Type", "application/json");
    ...
    IEnumerator Shopitem1(ShopitemModel shopitemModel)
    {
        ...
        var request = new UnityWebRequest("http://localhost:3005/users/buy-item", "POST");
        byte[] bodyRaw = Encoding.UTF8.GetBytes(jsonStringRequest);
        request.uploadHandler = new UploadHandlerRaw(bodyRaw);
        request.downloadHandler = new DownloadHandlerBuffer();
        request.SetRequestHeader("Content-Type", "application/json");
    ...
    IEnumerator Shopweapon1(ShopweaponModel shopweaponModel)
    {
        ...
        var request = new UnityWebRequest("http://localhost:3005/users/buy-weapon", "POST");
        byte[] bodyRaw = Encoding.UTF8.GetBytes(jsonStringRequest);
        request.uploadHandler = new UploadHandlerRaw(bodyRaw);
        request.downloadHandler = new DownloadHandlerBuffer();
        request.SetRequestHeader("Content-Type", "application/json");
